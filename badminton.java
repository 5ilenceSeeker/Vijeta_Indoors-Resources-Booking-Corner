	...
	public badminton() {
		...
		backBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				setVisible(false);
				badmintonsearch fs= new badmintonsearch();
				fs.setVisible(true);
			}
		});
		...
		JLabel lblTable = new JLabel("Court");
...
//					System.out.println(a);
					if(validEntries()) {
						...
						String query1="select Name ,mobile ,fromm , tooo , roll , tablee from badminton Where fromm= '"+ from.getText() +"' and Date = '"+ date +"' and tablee='"+ tablee.getText() +"'";
						...
						if(count==0) {
							String query="insert into badminton(Name,fromm,tooo,mobile,Date,roll,tablee) values(?,?,?,?,?,?,?)";
							...
							JOptionPane.showMessageDialog(null, "Thank you for booking court no."+tablee.getText() + " from" + from.getText() + " to" + to.getText());
